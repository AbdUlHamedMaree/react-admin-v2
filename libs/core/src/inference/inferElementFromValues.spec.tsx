...
describe('inferElementFromValues', () => {
  ...
  it('should fall back to the nearest type if type is absent', () => {
    ...
    expect(inferElementFromValues('id', ['foo'], types).getElement()).toEqual(
      <Good source='id' />
    );
  });
  it('should return an id field for field named id', () => {
    ...
    expect(inferElementFromValues('id', ['foo', 'bar'], types).getElement()).toEqual(
      <Good source='id' />
    );
  });
  ...
  it('should return a boolean field for boolean values', () => {
    ...
    expect(
      inferElementFromValues('foo', [true, false, true], types).getElement()
    ).toEqual(<Good source='foo' />);
  });
  ...
  it('should return an email field for email name', () => {
    ...
    expect(inferElementFromValues('email', ['whatever'], types).getElement()).toEqual(
      <Good source='email' />
    );
  });
  ...
  it('should return a url field for url name', () => {
    ...
    expect(
      inferElementFromValues('url', ['whatever', 'whatever'], types).getElement()
  ...
  it('should return a date field for date string values', () => {
    ...
    expect(
      inferElementFromValues('foo', ['2018-10-01', '2018-12-03'], types).getElement()
    ).toEqual(<Good source='foo' />);
  });
  ...
  it('should return a string field for string values', () => {
    ...
    expect(
      inferElementFromValues('foo', ['This is Good', 'hello, World!'], types).getElement()
    ).toEqual(<Good source='foo' />);
  });
  it('should return a number field for number values', () => {
    ...
    expect(inferElementFromValues('foo', [12, 1e23, 653.56], types).getElement()).toEqual(
      <Good source='foo' />
    );
  });
