...
describe('CreateBase', () => {
  ...
  it('should give access to the current onSuccess function', () => {
    ...
    renderWithRedux(
      <DataProviderContext.Provider value={dataProvider}>
        <CreateBase {...defaultProps} undoable={false} onSuccess={onSuccess}>
          <Child />
        </CreateBase>
  ...
  it('should give access to the current onFailure function', () => {
    ...
    renderWithRedux(
      <DataProviderContext.Provider value={dataProvider}>
        <CreateBase {...defaultProps} undoable={false} onFailure={onFailure}>
          <Child />
        </CreateBase>
      </DataProviderContext.Provider>,
      { admin: { resources: { posts: { data: {} } } } }
  ...
  it('should give access to the current transform function', () => {
    ...
    renderWithRedux(
      <DataProviderContext.Provider value={dataProvider}>
        <CreateBase {...defaultProps} undoable={false} transform={transform}>
          <Child />
        </CreateBase>
      </DataProviderContext.Provider>,
      { admin: { resources: { posts: { data: {} } } } }
