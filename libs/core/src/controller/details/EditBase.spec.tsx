...
describe('EditBase', () => {
  ...
  it('should give access to the current onSuccess function', () => {
    ...
    renderWithRedux(
      <DataProviderContext.Provider value={dataProvider}>
        <EditBase {...defaultProps} undoable={false} onSuccess={onSuccess}>
          <Child />
        </EditBase>
  ...
  it('should give access to the current onFailure function', () => {
    ...
    renderWithRedux(
      <DataProviderContext.Provider value={dataProvider}>
        <EditBase {...defaultProps} undoable={false} onFailure={onFailure}>
          <Child />
        </EditBase>
      </DataProviderContext.Provider>,
      { admin: { resources: { posts: { data: {} } } } }
  ...
  it('should give access to the current transform function', () => {
    ...
    renderWithRedux(
      <DataProviderContext.Provider value={dataProvider}>
        <EditBase {...defaultProps} undoable={false} transform={transform}>
          <Child />
        </EditBase>
      </DataProviderContext.Provider>,
      { admin: { resources: { posts: { data: {} } } } }
