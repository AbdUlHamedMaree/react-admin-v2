...
const FormBody = ({ handleSubmit }) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <Field name='author.name' aria-labelledby='author-label' component='input' />
...
const FormUnderTest = ({ initialValues = {} }) => {
  ...
  return <Form onSubmit={onSubmit} initialValues={initialValues} component={FormBody} />;
};
...
describe('useWarnWhenUnsavedChanges', () => {
  ...
  test.each([
    ...
    (_, field) => {
      ...
      expect((getByLabelText('First Name') as HTMLInputElement).value).toBe('John Doe');
